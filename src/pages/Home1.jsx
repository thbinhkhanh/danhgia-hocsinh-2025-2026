...
useEffect(() => {
  ...
  const handleStatusChange = (maDinhDanh, status) => {
    setStudentStatus((prev) => {
      const updated = { ...prev };
      if (prev[maDinhDanh] === status) {
        delete updated[maDinhDanh];
      } else {
        updated[maDinhDanh] = status;
      }
      return updated;
    });
  };
                  ...
                  <Box key={student.maDinhDanh} sx={{ position: "relative" }}>
                    ...
                    <Paper
                      ...
                      sx={{
                        ...
                        textAlign: "left",
                        bgcolor: !isExpanded ? (status ? colors.bg : "white") : "white", // nền theo trạng thái chỉ khi overlay đóng
                        ...
                        <Stack spacing={1}>
                          {["Chưa hoàn thành", "Hoàn thành", "Hoàn thành tốt"].map((s) => (
                            <Button
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                handleStatusChange(student.maDinhDanh, s);
