        ...
        <Box sx={{ flex: 1, minWidth: 300 }}>
          ...
          <Stack spacing={2}>
            ...
            <Button
              ...
              sx={{
                bgcolor: "#f44336",        // màu nền đỏ
                color: "#fff",             // màu chữ trắng
                borderColor: "#f44336",    // viền cùng màu nền
                "&:hover": {
                  bgcolor: "#d32f2f",      // màu nền khi hover
                  borderColor: "#d32f2f",
                },
              }}
            >
            ...
            <Button
              ...
              sx={{
                bgcolor: "#ff9800",       // nền cam (MUI warning chính là cam)
                color: "#fff",            // chữ trắng
                borderColor: "#ff9800",   // viền cam
                "&:hover": {
                  bgcolor: "#f57c00",     // cam đậm khi hover
                  borderColor: "#f57c00",
                },
              }}
            >
