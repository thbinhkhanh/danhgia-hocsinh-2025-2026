...
{q.type === "single" && (
<Radio checked={q.correct?.[0] === oi} onChange={() => update(qi, { correct: [oi] })} size="small" />
)}
{q.type === "multiple" && (
<Checkbox
...
newCorrect = newCorrect.filter((c) => c !== oi).map((c) => (c > oi ? c - 1 : c));
...
<Button variant="outlined" onClick={() => update(qi, { options: [...q.options, ""] })}>
Thêm mục
</Button>
</Stack>
);
